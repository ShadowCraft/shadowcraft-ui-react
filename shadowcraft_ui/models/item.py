...
MISSING_ITEMS = [121128, 121293, 121299, 134152, 134154, 134192, 134194, 134196, 134197, 134199,
                 ...
                 134284, 134285, 146768, 146769, 146770, 146771, 146772, 146773, 146774, 146775]
...
BLACKLIST = [139321, 139323, 139324, 139326, 139327, 139330, 139333, 139335, 139336, 131735, 140030,
             ...
             147023, 147024, 147025, 147026, 143604, 151967, 135925, 135928, 144455, 141904, 139238,
             151634, 151635, 151306, 151298, 142508, 141880, 140790]

# Transmog/other items that don't need to be in the list
BLACKLIST += [151662, 151666, 151667, 151674, 151678, 151680, 151687, 151691, # Riftscarred set
              147397, 147421, 150368, 150369, 150370, # Rating Min Item Level Reward items (?)
              141907, # Arena Victory Bonus (?)

              # Transmog weapons
              152336, 152337, 152338, 152339, 153254, 153255, 153256, 153257, 153258, 153260,
