...
export const _70_nhmItems = [
    // BRH
    136977, 139242, 134442, 134490, 134440, 134412, 134373, 136979, 134528, 136715, 136770, 139243, 134499, 134451, 
    // DHT
    134487, 134429, 139071, 134452, 121299, 134531, 134461, 139070, 137312, 137311, 137320, 134537, 134405, 121293, 134448,
    // EoA
    134240, 134441, 134492, 134525, 137364, 134238, 134406, 134539, 134456, 134239, 134438, 134497, 134532, 134459, 134237, 137373,
    // HoV
    ...
    // VH
    134493, 134445, 134411, 134457, 137461, 134404, 137435, 137439, 134454, 137438, 134450, 137442, 134534, 137425, 137427, 134489, 134541, 134527, 137448, 137449, 137455, 134368, 137459, 134446, 134407, 137458, 134498, 134439, 137432, 
    // Other (WQ bosses usually)
    146768, 146769, 146770, 146771, 146772, 146773, 146774, 146775,
];
...
export const _70_suramarItems = [
    // CoS
    134280, 137480, 137483, 134460, 134374, 134529, 137487, 134447, 137486, 137497, 134287, 134542,
    // Arcway
    137397, 134526, 134488, 134402, 134453, 134449, 137406, 134533, 134540, 137409, 134410, 137418, 137415, 134444, 137419, 134286,
];
...
export const _karaSecondSetItems = [
    142144, 142167, 142142, 142215, 142207, 142172, 142173, 142141, 142145
];
