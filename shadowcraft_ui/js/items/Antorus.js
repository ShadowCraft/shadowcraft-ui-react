...
// TODO: add tier items
export const _items = [
    151968, 151964, 151963, 151993, 152087, 152413, 151985, 152681, 151988, 151989, 151980,
    151979, 151992, 152414, 152086, 151984, 151990, 151991, 151987, 152282, 151983, 151981,
    152412, 151937, 151938, 152062, 152063, 152688, 152284, 152064, 151973, 151965, 151966,
    152160, 152161, 152162, 152163, 152164, 152165, 152093
];

export const _itemBonusMap = {
    915: [3613, 1457], //rf
    930: [3610, 1472], //normal
    945: [3611, 1487], //heroic
    960: [3612, 1502], //mythic
};
...
export const _bossItemBonuses = {
    925: [3613, 1457], //rf
    940: [3610, 1472], //normal
    955: [3611, 1487], //heroic
    970: [3612, 1502], //mythic
};
