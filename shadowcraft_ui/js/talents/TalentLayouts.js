export const assassination_layout = {
    name: 'Assassination',
...
export const assassination_ranking = [
    {
        name: 'Tier 15',
        items: [
            {
